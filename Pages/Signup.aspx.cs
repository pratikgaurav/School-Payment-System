...
public partial class Signup : System.Web.UI.Page
{
    ...
    protected void Unnamed_Click1(object sender, EventArgs e)
    {
        ...
        cn.Open();
        SqlCommand cmd = new SqlCommand("INSERT INTO Kamireddig_WADsp17_UserInfor(EmailAddress,Password,FirstName,LastName,SecurityQuestion,SecurityQuestionAnswer,StateOrProvince,SchoolDistrictName) VALUES (@EmailAddress,@Password,@FirstName,@LastName,@SecurityQuestion,@SecurityQuestionAnswer,@StateOrProvince,@SchoolDistrictName)", cn);
        ...
        cmd.Parameters.AddWithValue("@SecurityQuestionAnswer", aUser.SecurityQuestionAnswer);
        cmd.Parameters.AddWithValue("@StateOrProvince", aUser.StateOrProvince);
        cmd.Parameters.AddWithValue("@SchoolDistrictName", aUser.SchoolDistrictName);
        cmd.ExecuteNonQuery();
        cn.Close();
